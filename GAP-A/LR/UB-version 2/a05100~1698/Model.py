...
#step 1:UB generation(Version-2:generate UB acording LB)
...
# step 2:UB generation (Handly, local search)
            ...
            for j in S_2:
                ...
                for m in served_KS_list:
                    Agent = self.agent_list[m]
                    utility=(-1)*(Agent.cost_list_each_job[j]+self.job_list[j].multiplier)/Agent.resource_list_each_job[j]
